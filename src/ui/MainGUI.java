...
public class MainGUI extends JFrame implements ActionListener {
    ...
    private static final String BOARD_SIZE_MENU_STRING = "domain.Board size";
    private static final String SINGLE_GAME_OPTION_STRING = "Single-domain.Game";
    ...
    private static final String SMALL_BOARD_OPTION_STRING = "Small domain.Board";
    private static final String MEDIUM_BOARD_OPTION_STRING = "Medium domain.Board";
    private static final String LARGE_BOARD_OPTION_STRING = "Large domain.Board";
    ...
    private static final String BOARD_SIZE_CHANGE_WARNING_TITLE = "domain.Board Size Change";
